    ...
    <>
      ...
      <section className="py-20 bg-gradient-to-r from-[#2e5311] to-[#1b310a] relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center" data-aos="fade-up">
          ...
          <p className="text-xl text-[#e0eed5] mb-10 max-w-2xl mx-auto">Tham gia cùng 50,000+ học sinh khác đã thành công với phương pháp học chủ động tại Trung tâm giáo dục MathPlus Academy</p>
      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <Image
              src={logoUrl}
              alt="Trung tâm giáo dục MathPlus Academy Logo Footer"
              width={177}
              height={58}
              className="mb-6 rounded-full w-16 h-16 object-cover"
            />
            <p className="text-sm text-gray-300 leading-relaxed">
              Trung tâm giáo dục MathPlus Academy là hệ thống trung tâm bồi dưỡng và luyện thi Toán hàng đầu tại Việt Nam, mang đến phương pháp học tập chủ động, giúp học sinh yêu thích và giỏi môn Toán.
            </p>
          </div>
          <div>
        ...
        <div className="border-t border-gray-700 mt-12 pt-8 text-center text-gray-400 text-sm">
          © {new Date().getFullYear()} Trung tâm giáo dục MathPlus Academy. All rights reserved.
        </div>
      </div>
    </footer>
    </>
