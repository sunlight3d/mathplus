...
def build_mathplus_exam_docx(output_path):
    ...
    # Create a nice header table with Logo on Left and Center/Right Title
    ...
    run_htext.font.color.rgb = RGBColor(27, 94, 32) # Dark green MathPlus
    ...
    run_foot.font.color.rgb = RGBColor(50, 50, 50)
    ...
    # Box "Đề thi gồm 2 trang"
    p_box = cell_left.add_paragraph()
    p_box.alignment = WD_ALIGN_PARAGRAPH.CENTER
    p_box.paragraph_format.space_before = Pt(6)
    r_box = p_box.add_run("Đề thi gồm 2 trang")
    r_box.bold = True
    ...
    p_b1_1.paragraph_format.space_after = Pt(4)
    r1 = p_b1_1.add_run("1) ")
    r1.bold = True
    ...
    for c_idx in range(10):
        tbl1.columns[c_idx].width = Cm(1.4)
    ...
    p_b1_1_sub.paragraph_format.space_before = Pt(4)
    ...
    p_wl2.paragraph_format.space_before = Pt(4)
    ...
    if os.path.exists(wheel_img_path):
        p_wr.add_run().add_picture(wheel_img_path, width=Cm(4.5))
    ...
    if os.path.exists(slope_img_path):
        ...
        p_slope_img.add_run().add_picture(slope_img_path, width=Cm(8.5))
    ...
    p_b4_1_txt._p.append(create_math_element(mr('6°')))
    ...
    p_b4_1_a.paragraph_format.left_indent = Cm(0.5)
    r = p_b4_1_a.add_run("a) ")
    r.bold = True
    p_b4_1_a.add_run("Hãy tính góc dốc.")
    
    p_b4_1_b = doc.add_paragraph()
    p_b4_1_b.paragraph_format.left_indent = Cm(0.5)
    ...
    p_b4_2_a.paragraph_format.left_indent = Cm(0.5)
    r = p_b4_2_a.add_run("a) ")
    r.bold = True
    p_b4_2_a.add_run("Tính độ dài các cạnh ")
    p_b4_2_a._p.append(create_math_element(mr('AC, AH')))
    p_b4_2_a.add_run(" và số đo góc ")
    p_b4_2_a._p.append(create_math_element(mr('B')))
    p_b4_2_a.add_run(" (làm tròn đến phút) nếu ")
    p_b4_2_a._p.append(create_math_element(mr('AB = 3\\text{ cm}; BC = 5\\text{ cm}').replace('\\text{ cm}', ' cm')))
    p_b4_2_a.add_run(".")
    
    # b)
    p_b4_2_b = doc.add_paragraph()
    p_b4_2_b.paragraph_format.left_indent = Cm(0.5)
    ...
    p_b4_2_c.paragraph_format.left_indent = Cm(0.5)
    ...
    r_b5.bold = True
    r_b5.italic = True
    p_b5.add_run("Người ta trộn 4 kg chất lỏng loại I với 3 kg chất lỏng loại II thì được một hỗn hợp có khối lượng riêng là ")
    p_b5._p.append(create_math_element(mr('700 kg/m') + msup(mr(''), mr('3'))))
    p_b5.add_run(". Biết khối lượng riêng của chất lỏng loại I lớn hơn khối lượng riêng của chất lỏng loại II là ")
    p_b5._p.append(create_math_element(mr('200 kg/m') + msup(mr(''), mr('3'))))
    p_b5.add_run(". Tính khối lượng riêng của mỗi chất.")
    ...
    r_s1 = p_sig.add_run("Họ và tên thí sinh: ")
    r_s1.bold = True
    r_s1.italic = True
    p_sig.add_run("........................................................................ ")
    r_s2 = p_sig.add_run("Số báo danh: ")
    r_s2.bold = True
    r_s2.italic = True
    p_sig.add_run("........................................")
